...
exports.seedChecklistTemplates = void 0;
 ...
 */
exports.seedChecklistTemplates = (0, https_1.onCall)(async (request) => {
    var _a;
    ...
    const mineId = request.data.mineId;
    if (!mineId) {
        throw new https_1.HttpsError("invalid-argument", "mineId is required.");
    }
    const batch = db.batch();
    // Worker template
    batch.set(db.collection("checklist_templates").doc(`${mineId}_worker`), {
    ...
    batch.set(db.collection("checklist_templates").doc(`${mineId}_supervisor`), {
...
//# sourceMappingURL=seedChecklistTemplates.js.map